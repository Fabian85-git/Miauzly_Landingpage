      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Die Schweizer Plattform für Katzensitting und Community.
            </p>
          </div>
          
          {/* Links */}
          <div className="space-y-4">
            <h4 className="text-sm opacity-60">Rechtliches</h4>
          ...
          {/* Social */}
          <div className="space-y-4">
            <h4 className="text-sm opacity-60">Folge uns</h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © 2025 miauzly.ch – Ein Projekt aus der Schweiz 🇨🇭
          </p>
          <p className="text-gray-400 text-sm">
            Mit ❤️ für Katzen gemacht
          </p>
        </div>
      </div>
    </footer>
