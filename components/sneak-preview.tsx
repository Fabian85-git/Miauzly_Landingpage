                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                          ...
                          <div className="flex gap-1">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <div key={star} className="w-3 h-3 text-[#FFB7C5]">
                                ⭐
                              </div>
                            ))}
                          </div>
                ...
                <div className="p-4 space-y-4 bg-gray-50">
                  <div className="text-center">
                    ...
                    <div className="inline-flex gap-2 bg-white rounded-full p-1 shadow-sm">
                      <button className="px-4 py-2 rounded-full bg-[#F2A81D] text-white text-xs">Angebote</button>
                      <button className="px-4 py-2 rounded-full text-[#6B6B6B] text-xs">Gesuche</button>
                    </div>
                  </div>
